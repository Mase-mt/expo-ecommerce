  ...
  return (
    <View className='px-8 flex-1 justify-center items-center bg-white'>
      ...
      <Text className='text-center text-gray-500 text-xs leading-4 mt-6 px-2'>
          By signing up, you agree to our <Text className='text-blue-500'>Terms</Text> {", "} <Text className='text-blue-500'>Privacy Policy</Text>{", and "} <Text className='text-blue-500'>Cookie use</Text>
      </Text>
    </View>
  )
}
