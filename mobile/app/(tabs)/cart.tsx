...
const CartScreen = () => {
  ...
  const [payemntLoading, setPayementLoading] = useState(false);
  ...
  const handleProceedWithPayment = async (selectedAddress: Address) => {
    ...
    try {
      ...
      if (presentError) {
        ...
        Alert.alert(
          "Success",
          "Your payemnt was successful. Your order is being processed!",
          [{ text: "Ok", onPress: () => {} }],
        );
      }
      clearCart();
      ...
      Alert.alert("Error", "Failed to proceed payment!");
    } finally {
      setPayementLoading(false);
    }
  };
